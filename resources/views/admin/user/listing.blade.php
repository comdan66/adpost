					...
					<div class="row">
						<div class="col-lg-12">
							<div class="pull-left" style="padding-top:10px">
								...
								一般會員<span>@{{ countNormal }}</span>個,  
								廣告會員<span>@{{ countAd}}</span>個
							</div>
						...
						<table class="table table-striped table-bordered table-hover dataTable">
							...
							<thead>
								<tr>
									...
									<th style="width:auto" class="sortable" v-on:click="changeOrder('email')" orderable>信箱</th>
									<th style="width:auto" class="sortable" v-on:click="changeOrder('roleID')" orderable>身分</th>
									<th style="width:220px">Functions</th>
								</tr>
								<tr>
									...
									<th>
									<select class="form-control" v-model="search.roleID">
...
<script>
	...
	vueListData.data.countNormal = vueData.countNormal;
	vueListData.data.countAd = vueData.countAd;
