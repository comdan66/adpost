						...
						<table class="table table-striped table-bordered table-hover dataTable">
							...
							<thead>
								<tr>
									...
									<th style="width:120px" class="sortable" v-on:click="changeOrder('name')" orderable>使用者名稱</th>
									<th style="width:auto" class="sortable" v-on:click="changeOrder('content')" orderable>留言</th>
									<th style="width:160px" class="sortable" v-on:click="changeOrder('created_at')" orderable>時間</th>
