					...
					<li>
						<div class="pic">
							<div class="embed-responsive embed-responsive-16by9">
								<iframe class="yt-item" id="yt0" src="http://www.youtube.com/embed/erDxb4IkgjM?rel=0&wmode=Opaque&enablejsapi=1;showinfo=0;controls=1;showinfo=0" frameborder="0" allowfullscreen></iframe>
							</div>
						</div>
					</li>
					<li>
						<div class="pic">
							<div class="embed-responsive embed-responsive-16by9">
								<iframe class="yt-item" id="yt1" src="http://www.youtube.com/embed/erDxb4IkgjM?rel=0&wmode=Opaque&enablejsapi=1;showinfo=0;controls=1;showinfo=0" frameborder="0" allowfullscreen></iframe>
							</div>
						</div>
					</li>
					<li>
						<div class="pic">
							<div class="embed-responsive embed-responsive-16by9">
								<iframe class="yt-item" id="yt2" src="http://www.youtube.com/embed/erDxb4IkgjM?rel=0&wmode=Opaque&enablejsapi=1;showinfo=0;controls=1;showinfo=0" frameborder="0" allowfullscreen></iframe>
							</div>
						</div>
					</li>
					<li>
						<div class="pic">
							<div class="embed-responsive embed-responsive-16by9">
								<iframe class="yt-item" id="yt3" src="http://www.youtube.com/embed/erDxb4IkgjM?rel=0&wmode=Opaque&enablejsapi=1;showinfo=0;controls=1;showinfo=0" frameborder="0" allowfullscreen></iframe>
							</div>
						</div>
					</li>
					<li>
						<div class="pic">
							<div class="embed-responsive embed-responsive-16by9">
								<iframe class="yt-item" id="yt4" src="http://www.youtube.com/embed/erDxb4IkgjM?rel=0&wmode=Opaque&enablejsapi=1;showinfo=0;controls=1;showinfo=0" frameborder="0" allowfullscreen></iframe>
							</div>
						</div>
					</li>
				</ul>
		...
		<div class="container">
			...
			<div class="guest-group">
				<div class="guest-message">
					...
					<div class="pic col-sm-2 col-lg-1 hidden-xs"><img src="/images/pic-guest.jpg" class="img-circle">
					</div>
