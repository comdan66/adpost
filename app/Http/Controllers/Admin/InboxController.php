...
class InboxController extends _ControllerAdmin {

	public $moduleName = '訊息箱';
	...
	public function getList() {
		...
		$result = Inbox::orderby($orderField, $orderType);

		addWhere($result, 'id');
		addWhere($result, 'typeID');
		addWhere($result, 'userID');
		addWhere($result, 'name', 'like');
		addWhere($result, 'content', 'like');
		addWhere($result, 'sequence');

		addWhere($result, 'priceInternetFrom', '>=', 'priceInternet');
		addWhere($result, 'priceInternetTo', '<=', 'priceInternet');
		addWhere($result, 'priceInboxFrom', '>=', 'priceInbox');
		addWhere($result, 'priceInboxTo', '<=', 'priceInbox');
