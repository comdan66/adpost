				...
				<div class="panel-body" >
					...
					<div class="row">
						...
						<div class="col-sm-3 col-xs-12">
							...
							<div class="form-group">
								<label>名稱</label>
								<input class="form-control" placeholder="" v-model="item.name" readonly/>
							</div>

						</div>
						<div class="col-sm-9 col-xs-12">

							@include('admin/setting/_about')
							@include('admin/setting/_contact')
							@include('admin/setting/_adminEmail')
							@include('admin/setting/_cooperation')
							@include('admin/setting/_index')
							@include('admin/setting/_ad')
							@include('admin/setting/_adApprove')
