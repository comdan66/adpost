				...
				<div class="crop-form col-xs-12 col-sm-6">
					<form role="form" id="vue">
						...
						<div class="upload form-group">
							<div class="row">
								<label class="col-xs-12"> <span class="col-xs-3"><span class="highlight">*</span>上傳附件</span> <!-- <input type="file" style="display: none"> -->
									<input  class="hidden form-control" type="file"  v-on:change="uploadFile($event, 'file')" />
